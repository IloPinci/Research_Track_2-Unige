...
public:
  ...
  : Node("pose_server_component", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<MovePose>(
      this, "move_to_pose",
      std::bind(&PoseServerComponent::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
      std::bind(&PoseServerComponent::handle_cancel, this, std::placeholders::_1),
      std::bind(&PoseServerComponent::handle_accepted, this, std::placeholders::_1)
    );
  }
...
private:
  ...
  {
    std::thread{std::bind(&PoseServerComponent::execute, this, std::placeholders::_1), goal_handle}.detach();
  }
